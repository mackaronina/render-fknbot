...
cursor = create_engine(f'postgres+psycopg2://postgres.hdahfrunlvoethhwinnc:gT77Av9pQ8IjleU2@aws-0-eu-central-1.pooler.supabase.com:5432/postgres', pool_recycle=280, connect_args={'ssl': {'ssl-mode': 'preferred'}})
db = []
# ☣️
