...
cursor = create_engine('mysql+pymysql://68p1cik321lxjjz3bqdi:pscale_pw_yYTdRg4Y6mZXSZWIEaXrKlL4ibLCdGJ2hcVDFgKRftF@aws.connect.psdb.cloud:3306/nekodb', pool_recycle=280, connect_args={'ssl': {'ssl-mode': 'preferred'}})
db = []
# ☣️
